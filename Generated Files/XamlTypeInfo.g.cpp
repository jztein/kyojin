...
{
    if (typeName == L"Windows.UI.Xaml.Controls.SwapChainBackgroundPanel")
    {
    ...
    if (typeName == L"GameEngine.DirectXPage")
    {
        ::XamlTypeInfo::InfoProvider::XamlUserType^ userType = ref new ::XamlTypeInfo::InfoProvider::XamlUserType(this, typeName, GetXamlTypeByName(L"Windows.UI.Xaml.Controls.SwapChainBackgroundPanel"));
        userType->KindOfType = ::Windows::UI::Xaml::Interop::TypeKind::Custom;
        userType->Activator =
            []() -> Platform::Object^ 
            {
                return ref new ::GameEngine::DirectXPage(); 
            };
        return userType;
    }
